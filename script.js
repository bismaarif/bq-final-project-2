...
if (bar) {
    bar.addEventListListener('click', () => {
...
if (close) {
    close.addEventListListener('click', () => {
...
function sendEmail() {
    ...
    Email.send({
        SecureToken: "9a5cffe4-4afb-4091-93fd-3bf2264fb070",
        To: 'mahaadnan436@gmail.com',
        From: "mahaadnan436@gmail.com",
